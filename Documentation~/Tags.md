...
Looga Tags adds color-coded project tags to GameObjects. Use the `Components` and `Tags` tabs in the GameObject inspector utility strip to switch between component filters and tag authoring.
