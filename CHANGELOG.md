...
- Added a searchable dock-tab menu for Unity, package, and project editor windows.
...
- Unified expanded `LoogaList` headers and elements inside one shared container.
